//Roll:1703065
//Question: Show an OpenGL Program which will show three same size triangles aligned in x axis with overlapping with blue color in red background using 3 VBO and 3 VAO.
